...
- [ ] 9. 評議員アニメーションの実装
  ...
  - [ ] 9.3 Opening Dialogueの実装
    - 複数のOpening Dialogueを用意
    - ランダムに選択して表示
    - _要件: 4.8, 4.9, 4.10_
  
  - [ ] 9.4 Thinking Phaseアニメーションの実装
